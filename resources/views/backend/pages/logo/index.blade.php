        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('logo.create') }}" >Add Logo</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
              <h3 class="card-Name">Logo DataTable</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <table id="dtable" class="table table-bordered table-striped">
                ...
                <tr>
                	<td>{{ $i }}</td>
                  <td> <img class="manage-img" width="120px" src="{!! url('images/'.$val->logo) !!}" alt="course image"></td>
                  <td>{{ $val->name }}</td>
					<td><span><a href="{{ route('logo.edit', $val->id) }}" data-toggle="tooltip" data-placement="top" Name="Edit" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> </a>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form  action="{{ route('logo.delete', $val->id) }} }}" method="post">
                                @csrf
